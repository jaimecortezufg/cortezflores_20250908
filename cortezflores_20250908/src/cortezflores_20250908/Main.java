...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //CREACIÓN E INSTANCIA ARREGLO DE NÚMEROS ORDENADOS
        ...
        //SE RECORRE EL ARREGLO DE NÚMEROS ENTEROS DESORDENADOS QUE POR DEFECTO
        //TIENEN EL VALOR DE CERO
        for(int i = 0; i < numeros_desordenados.length; i++){
            
            //SE SOLICIA AL USUARIO EL INGRESO DE UN VALOR
        ...
        for(int j = 0; j < numeros_desordenados.length; j++){
            ...
            //ALMACENADOS EN EL ARREGLO DE NÚMEROS DESORDENADOS
        ...
        for(int i=0; i < arreglo.length - 1; i++){
            ...
            for(int j=0; j<arreglo.length - 1; j++){
                ...
                if(arreglo[j] > arreglo[j+1]){
                    ...
                    //SE INTECAMBIA LA POSICIÓN DEL SIGUIENTE ELEMENTO
